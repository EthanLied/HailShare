...
<body>
    ...
    <div id="content">
        ...
        <a href="createSupportRequest/index.php">
            <button class="btnStrong" id="supportRequestBtn">
        ...
        <div id="tabList">
            <a id="ongoingChatsTab" onclick="switchTab('ongoing')">Ongoing Chats</a>
            <a id="pastChatsTab" onclick="switchTab('past')">Past Chats</a>
        </div>

        <div id="recordRowContainer">
