...
<body>
    ...
    <div id="content">
        ...
        <div id="rideRecordContainer">
            ...
            <div class="ongoingRidesItem hosted ongoing">
                <div class="leftSideItems">
                    <p class="rideIDLabel">Ride ID: <span>#018232</span></p>
                    <p>From: <span class="address">Lot No. 241, Level 2 Menara, Petronas Twin Tower, Kuala
                            Lumpur
                            City Centre, 50088 Kuala Lumpur, Wilayah Persekutuan Kuala Lumpur</span>
                    </p>
                    <p>To: <span>2 Jalan Punchak, Off, Jalan P. Ramlee, 50250 Kuala Lumpur</span></p>
                
                    <p>Time: <span>12:00 PM</span></p>
                    <p>Capacity: <span>3 / 5</span></p>
                    <p>Price: <span>RM 10</span></p>
                    </div>
                <div class="rightSideItems">
                    <a href="editRide/index.html">
                        <button class="btnNormal">Edit Ride <span
                                class="material-symbols-outlined">edit</span></button>
                    </a>
                    <a href="chatRoom/index.html">
                        <button class="btnNormal">Chatroom <span class="material-symbols-outlined">
                                chat
                            </span></button>
                    </a>
            ...
            <div class="ongoingRidesItem joined ongoing">
                <div class="leftSideItems">
                    <p class="rideIDLabel">Ride ID: <span>#018232</span></p>
                    <p>Time: <span>12:00 PM</span></p>
                    <p>Capacity: <span>3 / 5</span></p>
                ...
                <div class="rightSideItems">
                    <a>
                        <button class="btnNormal leaveRideBtn">Leave Ride <span
            ...
            <div class="rideHistoryItem hosted past">
                <div class="leftSideItems">
                    <p class="rideIDLabel">Ride ID: <span>#018232</span></p>
                    <p>Capacity: <span>3 / 5</span></p>
                    <p>Price: <span>RM 10</span></p>
                ...
                <div class="rightSideItems">
                    ...
                    <p>Time Hosted: <span>12:00 PM</span></p>
                    <p>Time Ended: <span>1:00 PM</span></p>
                    <p>To: <span>2 Jalan Punchak, Off, Jalan P. Ramlee, 50250 Kuala Lumpur</span></p>
                </div>
            </div>

            <div class="rideHistoryItem joined past">
                <div class="leftSideItems ">
                    <p class="rideIDLabel">Ride ID: <span>#018232</span></p>
                    <p>Capacity: <span>3 / 5</span></p>
                    <p>Price: <span>RM 10</span></p>
                ...
                <div class="rightSideItems">
                    ...
                    <a href="giveRating/index.html">
                        <button class="btnNormal">Give Rating <span class="material-symbols-outlined">
                                star
                            </span></button>
                    </a>
                    <p>Time Hosted: <span>12:00 PM</span></p>
