...
INSERT INTO `users` (`user_id`, `role_id`, `first_name`, `last_name`, `email`, `phone_number`, `password_hash`, `date_of_birth`, `security_question`, `security_question_answer`, `security_code`, `profile_picture`, `account_status`, `created_at`, `updated_at`) VALUES ('2', '2', 'Siti', 'Amina', 'siti.aminah@email.com', '+60198765432', '$2b$12$AnotherHashPlaceholderXYZABC', '1998-03-22', 'What is your mother maiden name?', '$2b$12$AnswerHashPlaceholder2XYZABC', NULL, 'uploads/profiles/siti_aminah.jpg', 'active', '2026-04-28 18:18:53', '2026-05-13 11:38:49');
...
INSERT INTO `rides` (`ride_id`, `user_id`, `pickup_location`, `pickup_lat`, `pickup_long`, `dropoff_location`, `dropoff_lat`, `dropoff_long`, `price`, `carplate_number`, `vehicle_model`, `pickup_time`, `available_seats`, `status`, `completed_at`, `created_at`, `updated_at`) VALUES ('4', '2', 'KL Tower Mini Zoo, Jalan Puncak, Kampung Cendana, Kuala Lumpur, 50250, Malaysia', '3.1526407', '101.7035046', 'Serampang Hill, Malaysia', '2.3621814', '102.7844764', '10.00', '', '', '2026-05-15 17:00:00', '5', 'closed', '2026-05-16 00:00:00', '2026-05-13 11:37:48', '2026-05-13 11:38:11');
...
INSERT INTO `ride_participants` (`participant_id`, `ride_id`, `user_id`, `status`, `joined_at`, `completed_at`) VALUES ('4', '1', '2', 'left', '2026-05-13 11:36:36', NULL);
INSERT INTO `ride_participants` (`participant_id`, `ride_id`, `user_id`, `status`, `joined_at`, `completed_at`) VALUES ('5', '4', '2', 'completed', '2026-05-13 11:37:48', NULL);
...
INSERT INTO `ride_chat_rooms` (`ride_chat_id`, `ride_id`, `guest_user_id`, `status`, `created_at`, `closed_at`) VALUES ('8', '4', '2', 'closed', '2026-05-13 11:37:48', NULL);
...
INSERT INTO `ride_chat_messages` (`message_id`, `ride_chat_id`, `sender_user_id`, `message_content`, `sent_at`) VALUES ('10', '6', '2', 'hi
', '2026-05-13 11:36:55');
INSERT INTO `ride_chat_messages` (`message_id`, `ride_chat_id`, `sender_user_id`, `message_content`, `sent_at`) VALUES ('11', '6', '2', 'test', '2026-05-13 11:36:59');
INSERT INTO `ride_chat_messages` (`message_id`, `ride_chat_id`, `sender_user_id`, `message_content`, `sent_at`) VALUES ('12', '8', '2', 'hi', '2026-05-13 11:38:06');
INSERT INTO `ride_chat_messages` (`message_id`, `ride_chat_id`, `sender_user_id`, `message_content`, `sent_at`) VALUES ('14', '6', '1', 'd', '2026-05-13 11:54:46');

INSERT INTO `support_chat_rooms` (`support_chat_id`, `customer_user_id`, `staff_user_id`, `status`, `started_at`, `issue_type`, `additional_notes`, `ended_at`) VALUES ('1', '2', '1', 'closed', '2026-04-28 10:00:00', 'Issue with specific ride', 'Sample Note', '2026-05-11 22:46:31');
INSERT INTO `support_chat_rooms` (`support_chat_id`, `customer_user_id`, `staff_user_id`, `status`, `started_at`, `issue_type`, `additional_notes`, `ended_at`) VALUES ('2', '2', NULL, 'closed', '2026-05-13 11:38:26', 'Ride Issue', 'Lost my phone', '2026-05-13 11:38:36');
...
INSERT INTO `support_chat_messages` (`message_id`, `support_chat_id`, `sender_user_id`, `message_content`, `sent_at`) VALUES ('11', '1', '2', 'hello', '2026-05-11 22:08:13');
