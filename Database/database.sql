...
INSERT INTO `rides` (`ride_id`, `user_id`, `pickup_location`, `pickup_lat`, `pickup_long`, `dropoff_location`, `dropoff_lat`, `dropoff_long`, `price`, `carplate_number`, `vehicle_model`, `pickup_time`, `available_seats`, `status`, `completed_at`, `created_at`, `updated_at`) VALUES ('1', '1', 'Sunway Pyramid, Petaling Jaya', '0.0000000', '0.0000000', 'KL Sentral, Kuala Lumpur', '0.0000000', '0.0000000', '8.00', 'WXY 1234', 'Perodua Myvi 2022', '2026-05-21 08:30:00', '3', 'active', NULL, '2026-04-28 18:18:53', '2026-05-11 15:27:47');
...
INSERT INTO `ride_chat_rooms` (`ride_chat_id`, `ride_id`, `guest_user_id`, `status`, `created_at`, `closed_at`) VALUES ('1', '1', '2', 'active', '2026-04-28 09:00:00', '2026-05-11 15:15:52');
...
INSERT INTO `ride_chat_messages` (`message_id`, `ride_chat_id`, `sender_user_id`, `message_content`, `sent_at`) VALUES ('2', '1', '2', 'Ok', '2026-05-11 16:14:50');

INSERT INTO `support_chat_rooms` (`support_chat_id`, `customer_user_id`, `staff_user_id`, `status`, `started_at`, `issue_type`, `additional_notes`, `ended_at`) VALUES ('1', '1', '1', 'active', '2026-04-28 10:00:00', 'Issue with specific ride', 'Sample Note', '2026-05-10 13:51:47');
INSERT INTO `support_chat_rooms` (`support_chat_id`, `customer_user_id`, `staff_user_id`, `status`, `started_at`, `issue_type`, `additional_notes`, `ended_at`) VALUES ('2', '1', NULL, 'closed', '2026-05-11 14:34:36', 'Ride Issue', 'ds', '2026-05-11 14:37:07');
