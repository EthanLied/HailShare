...
INSERT INTO `users` (`user_id`, `role_id`, `first_name`, `last_name`, `email`, `phone_number`, `password_hash`, `date_of_birth`, `security_question`, `security_question_answer`, `security_code`, `profile_picture`, `account_status`, `created_at`, `updated_at`) VALUES ('1', '1', 'Ahmad', 'Razif', 'ahmad.razif@email.com', '+60123456789', '$2a$10$.okaM72NiGwbFYW3hpy.geRZq4E97oD49OL7QWQh/9mweZIchc2Pe', '1995-06-15', 'What is your pet''s name?', 'Dog', NULL, 'uploads/profiles/ahmad_razif.jpg', 'active', '2026-04-28 18:18:53', '2026-05-08 23:49:14');
