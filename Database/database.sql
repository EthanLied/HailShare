...
INSERT INTO `support_chat_rooms` (`support_chat_id`, `customer_user_id`, `staff_user_id`, `status`, `started_at`, `issue_type`, `additional_notes`, `ended_at`) VALUES ('1', '1', '1', 'closed', '2026-04-28 10:00:00', 'Issue with specific ride', 'Sample Note', '2026-05-10 13:51:47');
INSERT INTO `support_chat_rooms` (`support_chat_id`, `customer_user_id`, `staff_user_id`, `status`, `started_at`, `issue_type`, `additional_notes`, `ended_at`) VALUES ('2', '1', NULL, 'waiting', '2026-05-10 13:46:05', 'Ride Issue', '', NULL);
