...
<div id="content" style="display: flex; flex-direction: column; align-items: center;">
    <div style="max-width: 700px; width: 100%;">
        <span class="adminBadge"><span class="material-symbols-outlined" style="font-size:18px;">verified</span> Administrator</span>
        ...
        <div style="display: flex; justify-content: center; margin-top: 20px;">
            <button class="btnNormal" style="color:red; border-color:#ffcccc; padding: 10px 30px;">Logout</button>
        </div>
    </div>
</div>
