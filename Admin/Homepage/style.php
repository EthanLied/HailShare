...
.profile-menu.open .profile-dropdown {
    animation: profileDropdown 0.18s ease-out both;
}
...
#navbar, #navbar.expand, #navbar > a, #content, #navbar .navbarItem {
...
.hero-subtitle {
    ...
    margin-bottom: 40px;
    opacity: 0.95;
    animation: slideInUp 1s cubic-bezier(0.34, 1.56, 0.64, 1) 0.2s both;
    line-height: 1.4;
}
...
.hero-cta-group {
    ...
    justify-content: center;
    flex-wrap: wrap;
    animation: slideInUp 1s cubic-bezier(0.34, 1.56, 0.64, 1) 0.4s both;
}
...
.hero-product-preview {
    ...
    animation: slideInUp 1s cubic-bezier(0.34, 1.56, 0.64, 1) 0.55s both;
}
...
.value-card-1 { animation-delay: 0.1s; }
.value-card-2 { animation-delay: 0.2s; }
.value-card-3 { animation-delay: 0.3s; }
.value-card-4 { animation-delay: 0.4s; }
...
.stat-card-fade:nth-child(1) { animation-delay: 0.1s; }
.stat-card-fade:nth-child(2) { animation-delay: 0.2s; }
.stat-card-fade:nth-child(3) { animation-delay: 0.3s; }
.stat-card-fade:nth-child(4) { animation-delay: 0.4s; }
